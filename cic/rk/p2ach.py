...
def solution_for_clawback(
    ...
    wrapped_claim_puzzle_hash = morph_puzzle_hash_with_delay(claim_puzzle_hash, delay_in_seconds)
    puzzle_hashes = [clawback_puzzle.get_tree_hash(), wrapped_claim_puzzle_hash]
    solution = solution_for_inner_solution(puzzle_hashes, clawback_puzzle, clawback_solution)
    return solution
...
def solution_for_claim_redemption(
    ...
    puzzle_hashes = [clawback_puzzle_hash, wrapped_claim_puzzle.get_tree_hash()]
    solution = solution_for_inner_solution(puzzle_hashes, wrapped_claim_puzzle, claim_solution)
    return solution
